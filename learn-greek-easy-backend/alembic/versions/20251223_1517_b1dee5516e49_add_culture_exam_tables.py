...
def upgrade() -> None:
    """Upgrade schema."""
    # Add CULTURE value to achievementcategory enum
    # This must happen before any operations that might use the new value
    op.execute("ALTER TYPE achievementcategory ADD VALUE IF NOT EXISTS 'CULTURE'")
...
def downgrade() -> None:
    """Downgrade schema."""
    # Note: PostgreSQL does not support removing enum values with ALTER TYPE
    # The CULTURE value will remain in achievementcategory enum
    # This is harmless - unused enum values don't affect functionality
