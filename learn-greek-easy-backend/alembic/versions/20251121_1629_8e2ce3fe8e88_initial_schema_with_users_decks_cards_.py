...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "level", sa.Enum("A1", "A2", "B1", "B2", "C1", "C2", name="decklevel"), nullable=False
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "difficulty", sa.Enum("EASY", "MEDIUM", "HARD", name="carddifficulty"), nullable=False
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("NEW", "LEARNING", "REVIEW", "MASTERED", name="cardstatus"),
            nullable=False,
        ),
        sa.Column(
            "created_at",
