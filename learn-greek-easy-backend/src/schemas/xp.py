...
# =============================================================================
# Unnotified Achievements Schemas
# =============================================================================


class UnnotifiedAchievementResponse(BaseModel):
    """Achievement that user hasn't been notified about yet.

    Maps to AchievementService.get_unnotified_achievements() items.
    """
...
class UnnotifiedAchievementsResponse(BaseModel):
    """Response for GET /xp/achievements/unnotified endpoint."""

    achievements: List[UnnotifiedAchievementResponse] = Field(
        ..., description="Newly unlocked achievements"
    )
    count: int = Field(..., ge=0, description="Number of unnotified achievements")


# =============================================================================
# Mark Notified Schemas
# =============================================================================


class MarkNotifiedRequest(BaseModel):
    """Request body for POST /xp/achievements/notified endpoint."""

    achievement_ids: List[str] = Field(
        ...,
        min_length=1,
        max_length=50,
        description="Achievement IDs to mark as notified",
    )


class MarkNotifiedResponse(BaseModel):
    """Response for POST /xp/achievements/notified endpoint."""

    marked_count: int = Field(..., ge=0, description="Number of achievements marked")
