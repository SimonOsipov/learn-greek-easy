...
Auth0 authentication, token management, and session operations.

Legacy email/password and Google OAuth authentication have been removed.
...
class AuthService:
    ...
    All authentication now flows through Auth0. Legacy email/password
    and Google OAuth methods have been removed.
