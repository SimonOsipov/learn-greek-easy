    ...
    async def seed_changelog_entries(self) -> dict[str, Any]:
        ...
        entries_data = [
            # New Features (4)
            {
                ...
                "title_el": "Νέοι τύποι καρτών λεξιλογίου",
                ...
                "content_el": "Προσθέσαμε **λεξιλόγιο** και *πολιτισμό* για να σας βοηθήσουμε να μάθετε ελληνικά πιο αποτελεσματικά.",
            ...
            },
            {
                ...
                "title_el": "Λειτουργία ηχητικής προφοράς",
                "title_ru": "Функция аудио произношения",
                "content_en": "Listen to native Greek pronunciation for all vocabulary cards.",
                "content_el": "Ακούστε την προφορά από φυσικούς ομιλητές για όλες τις κάρτες λεξιλογίου.",
            ...
            },
            {
                ...
                "title_el": "Πίνακας στατιστικών προόδου",
                "title_ru": "Панель статистики прогресса",
                "content_en": "Track your learning progress with detailed statistics and charts.",
                "content_el": "Παρακολουθήστε την πρόοδο μάθησης με λεπτομερή στατιστικά και γραφήματα.",
            ...
            },
            {
                ...
                "title_el": "Αλγόριθμος διαστημικής επανάληψης",
                "title_ru": "Алгоритм интервального повторения",
                "content_en": "Our new spaced repetition system helps you remember words **longer**.",
                "content_el": "Το νέο μας σύστημα διαστημικής επανάληψης σας βοηθά να θυμάστε λέξεις **περισσότερο**.",
            ...
            # Bug Fixes (4)
            {
                ...
                "title_el": "Διορθώθηκε πρόβλημα εμφάνισης καρτών",
                ...
                "content_el": "Επιλύθηκε ένα πρόβλημα όπου οι κάρτες μερικές φορές εμφανίζονταν λανθασμένα σε κινητές συσκευές.",
            ...
            },
            {
                ...
                "title_el": "Σταθερότητα συνεδρίας σύνδεσης",
                "title_ru": "Стабильность сеанса входа",
                "content_en": "Fixed occasional logout issues that some users experienced.",
                "content_el": "Διορθώθηκαν περιστασιακά προβλήματα αποσύνδεσης που αντιμετώπιζαν ορισμένοι χρήστες.",
            ...
            },
            {
                ...
                "title_el": "Διόρθωση αναπαραγωγής ήχου",
                "title_ru": "Исправление воспроизведения аудио",
                "content_en": "Audio now plays correctly on *all* supported browsers.",
                "content_el": "Ο ήχος παίζει πλέον σωστά σε *όλα* τα υποστηριζόμενα προγράμματα περιήγησης.",
            ...
            # Announcements (4)
            {
                ...
                "title_el": "Καλώς ήρθατε στο Learn Greek Easy!",
                "title_ru": "Добро пожаловать в Learn Greek Easy!",
                "content_en": "Thank you for joining us on your Greek learning journey!",
                "content_el": "Σας ευχαριστούμε που μας επιλέξατε για το ταξίδι σας στην εκμάθηση ελληνικών!",
            ...
            },
            {
                ...
                "title_el": "Προγραμματισμένη συντήρηση",
                "title_ru": "Запланированное обслуживание",
                "content_en": "Brief maintenance window scheduled for this weekend.",
                "content_el": "Σύντομο παράθυρο συντήρησης προγραμματισμένο για αυτό το Σαββατοκύριακο.",
            ...
            },
            {
                ...
                "title_el": "Ορόσημο κοινότητας",
                "title_ru": "Веха сообщества",
                "content_en": "We've reached **1,000** active learners! Thank you for your support.",
                "content_el": "Φτάσαμε τους **1.000** ενεργούς μαθητές! Σας ευχαριστούμε για την υποστήριξή σας.",
            ...
            },
            {
                ...
                "title_el": "Πρόγραμμα διακοπών",
                "title_ru": "Праздничный график",
                "content_en": "Our support team will have limited availability during the holidays.",
                "content_el": "Η ομάδα υποστήριξής μας θα έχει περιορισμένη διαθεσιμότητα κατά τη διάρκεια των διακοπών.",
