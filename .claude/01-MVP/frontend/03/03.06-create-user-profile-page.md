...
**Priority**: Medium
**Dependencies**: Task 03.05 (Protected Routes) ✅ Completed
...
**Success Criteria:**
- ✅ Profile page component created at `/src/pages/Profile.tsx`
- ✅ Two-column layout implemented (sidebar + main content)
- ✅ Mobile responsive with collapsible sidebar
- ✅ Basic routing added to App.tsx
...
**Success Criteria:**
- ✅ Avatar displayed with fallback initials
- ✅ User name and email shown
- ✅ Role badge with appropriate color (purple for premium, red for admin, gray for free)
...
- ✅ Name field editable (2-50 chars validation)
- ✅ Email field read-only with lock icon
- ✅ Avatar upload UI (placeholder functionality)
...
- ✅ Words learned with progress indicator
- ✅ Total XP with level calculation (every 1000 XP = 1 level)
...
- ✅ Daily goal slider (5-120 minutes)
- ✅ Notifications toggle switch
- ✅ Theme selector (future feature - disabled)
- ✅ Instant save on change with debounce
...
- ✅ Form validation for password rules
- ✅ Account deletion button with dialog
- ✅ Two-factor auth toggle (disabled - coming soon)
