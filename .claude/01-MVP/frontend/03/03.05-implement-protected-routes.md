...
**Dependencies**: Task 03.02 (Auth Store) ✅, Task 03.03 (Login) ✅, Task 03.04 (Registration) ✅
...
- [ ] Navigate to `/decks` → Redirects to `/login`
- [ ] Navigate to `/profile` → Redirects to `/login`
...
- [ ] Navigate to `/login` → Redirects to `/dashboard`
- [ ] Navigate to `/register` → Redirects to `/dashboard`
- [ ] Access all protected routes successfully
- [ ] Navigate to `/admin` → Shows unauthorized page (premium user)
- [ ] Logout → Redirects to `/login`

#### Admin User Tests (admin@learngreekeasy.com / Admin123!)
- [ ] Access `/admin` successfully
- [ ] Access all regular protected routes
- [ ] Navigate to auth pages → Redirects to dashboard

#### Edge Cases
- [ ] Invalid route `/invalid` → Shows 404 page
- [ ] Session expired → Redirects to login
- [ ] Direct URL access to protected route → Login → Returns to URL
