    ...
    >
      ...
      <div className="container relative z-10 mx-auto px-6 py-32 md:py-40">
        <div className="mx-auto max-w-6xl text-center">
          ...
          {/* Subheadline */}
          <p
            className="mx-auto mb-14 max-w-4xl text-balance text-2xl leading-relaxed text-foreground/90 [animation-delay:0.3s] motion-safe:animate-fade-up md:text-3xl lg:text-4xl"
          ...
          {/* Social proof hint */}
          <p className="mt-14 text-lg text-foreground/80 [animation-delay:0.5s] motion-safe:animate-fade-up">
            {t('hero.socialProof')}
          </p>
        </div>
      </div>
