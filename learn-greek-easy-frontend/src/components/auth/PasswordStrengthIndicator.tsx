 ...
 *
 * Advisory-only visual indicator for password strength.
 * Shows a progress bar with color-coded strength levels and descriptive text
 * when a password has been entered. The checklist of requirements was removed
 * in AUTH-02 (neither signup nor reset renders it anymore).
 */
 ...
 * @returns StrengthResult with score, level, and color
 */
