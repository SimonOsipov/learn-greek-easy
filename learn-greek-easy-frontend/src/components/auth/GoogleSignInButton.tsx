 ...
 * On success, exchanges the Google credential for app tokens via the backend.
 */
  ...
  const googleLogin = useGoogleLogin({
    onSuccess: async (tokenResponse: TokenResponse) => {
      ...
      try {
        ...
        // We need to get the ID token instead for our backend
        // Using implicit flow, we get access_token which we'll exchange
