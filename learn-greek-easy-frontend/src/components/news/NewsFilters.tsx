...
export function NewsFilters({
  ...
  return (
    ...
    >
      ...
      {/* Right group: difficulty segment + search */}
            ...
            {(['a2', 'b1'] as const).map((level) => {
              ...
              return (
                <button
                  ...
                  aria-pressed={isActive}
                  className={cn(
                    'h-[30px] cursor-pointer rounded-full px-4 font-practice-mono text-[12.5px] font-semibold tracking-wide transition-all duration-200',
                    isActive
