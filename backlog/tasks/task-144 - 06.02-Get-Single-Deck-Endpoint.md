...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [ ] #1 GET /api/v1/decks/{id} endpoint implemented
- [ ] #2 Returns deck with card_count field
- [ ] #3 Returns 404 for non-existent deck
- [ ] #4 Returns 404 for inactive deck (is_active=False)
- [ ] #5 DeckDetailResponse schema created with card_count field
- [ ] #6 Invalid UUID returns 422 validation error
- [ ] #7 Response includes all deck fields plus card_count
