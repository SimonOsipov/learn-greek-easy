...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [ ] #1 Unit tests created for all 6 endpoints
- [ ] #2 Tests cover success cases
- [ ] #3 Tests cover error cases (4xx responses)
- [ ] #4 Tests cover pagination and filtering
- [ ] #5 Tests cover authentication/authorization
- [ ] #6 Integration tests for full CRUD flow
- [ ] #7 Integration tests for search functionality
- [ ] #8 Integration tests for auth flow
- [ ] #9 All tests passing
- [ ] #10 Test coverage >90% for deck router
