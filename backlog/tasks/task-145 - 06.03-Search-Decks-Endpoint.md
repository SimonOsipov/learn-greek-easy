...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [ ] #1 GET /api/v1/decks/search endpoint implemented
- [ ] #2 Search is case-insensitive
- [ ] #3 Search matches partial text in name and description
- [ ] #4 Pagination works for search results
- [ ] #5 Missing `q` parameter returns 422 validation error
- [ ] #6 Empty `q` parameter returns 422 validation error
- [ ] #7 DeckSearchResponse schema created with query field
- [ ] #8 Only active decks are returned
- [ ] #9 Response includes total count for pagination
